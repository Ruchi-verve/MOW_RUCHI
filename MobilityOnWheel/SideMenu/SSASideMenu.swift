...
extension UIViewController {
    ...
    @objc var sideMenuViewController: SSASideMenu? {
        get {
...
@objc protocol SSASideMenuDelegate: AnyObject {
...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        init(alpha: Float = 1.0, scale: Float = 0.7, landscapeOffsetX: Float = 30, portraitOffsetX: Float = 90, minParallaxContentRelativeValue: Float = -25.0, maxParallaxContentRelativeValue: Float = 25.0, interactivePopGestureRecognizerEnabled: Bool = true) {
...
//    }
    ...
    @objc weak var delegate: SSASideMenuDelegate?
    ...
    @objc var leftMenuViewController: UIViewController? {
        willSet  {
    ...
    @objc convenience init(contentViewController: UIViewController, leftMenuViewController: UIViewController) {
        self.init()
    ...
    @objc convenience init(contentViewController: UIViewController, rightMenuViewController: UIViewController) {
        self.init()
        self.contentViewController = contentViewController
        self.rightMenuViewController = rightMenuViewController
    }
    
    @objc convenience init(contentViewController: UIViewController, leftMenuViewController: UIViewController, rightMenuViewController: UIViewController) {
        self.init()
        self.contentViewController = contentViewController
        self.leftMenuViewController = leftMenuViewController
        //self.rightMenuViewController = rightMenuViewController
...
//        switch SSAStatusBarStyle(rawValue: style) {
//        case .hidden?:
//            style = .default
//        case .black?:
//            style = .default
