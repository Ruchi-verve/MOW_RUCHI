...
import SwiftyJSON
import CoreData
class SelectDest_view: SuperViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    lazy var arrMainSelectData = [String:[DestResSubModel]]()
    lazy var strSelectedDestination:String? = nil
    lazy  var SelectedDestinationId:Int? = nil
    lazy var DeliveryFee:Float? = nil
    lazy var dataKeys : Array = [String]()
    lazy var arrGetValues  = DestResSubModel()
    lazy var strIsComeFrom:String = ""
    lazy var arrFilterArrayWithCat = [[String:Any]]()
    lazy var arrSelectDestData = [[DestResSubModel]]()
...
//        }
    ...
    override func viewWillAppear(_ animated: Bool) {
        Common.shared.setCornerRadiustoView(viewDestination, passRadius: 8)
