...
//  MobilityOnWheel
//
//  Created by Khushbu Lotia on 26/08/21.
//
...
class CheckOutModel:NSObject {
    let priceAdjustment = "PriceAdjustment"
    let taxOnPrice = "TaxOnPrice"
    let orderID = "OrderId"
    let priceWithTax = "PriceWithTax"
    let isPrimaryOrder = "IsPrimaryOrder"
    let primaryOrderID = "PrimaryOrderId"
    let customerID = "CustomerID"
    let createdBy = "CreatedBy"
    let isCompanyOrder = "IsCompanyOrder"
    let pickupLocationID = "PickupLocationID"
    let customerPickupLocationID = "CustomerPickupLocationID"
    let pickupLocationTaxRate = "PickupLocationTaxRate"
    let isAcceptBonusDayLocation = "IsAcceptBonusDayLocation"
    let isRewardTurnOn = "IsRewardTurnOn"
    let bounceBack = "BounceBack"
    let cashTotal = "CashTotal"
    let creditTotal = "CreditTotal"
    let paymentProfileID = "PaymentProfileID"
    let companyID = "CompanyID"
    let companyTaxRate = "CompanyTaxRate"
    let listEquipmentOrderDetail = "listEquipmentOrderDetail"
    let equipmentOrderDetailRequest = "equipmentOrderDetailRequest"
    let totalBonusDays = "TotalBonusDays"
    let deliveryFee = "DeliveryFee"
    let deliveryFeeWithTax = "DeliveryFeeWithTax"
    let operatorID = "OperatorId"
    let deviceOrignalPriceWithChairPad = "DeviceOrignalPriceWithChairPad"
...
//
//
//    func initWithDictionary(dictionary:[String : JSON]) -> CheckOutModel {
//
